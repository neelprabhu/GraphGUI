...
%      applied to the GraphGUI before GraphGUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GraphGUI_OpeningFcn via varargin.
%
%      *See GraphGUI Options on GUIDE's Tools menu.  Choose "GraphGUI allows only one
...
% --- Executes just before GraphGUI is made visible.
function GraphGUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GraphGUI (see VARARGIN)
...
% UIWAIT makes GraphGUI wait for user response (see UIRESUME)
